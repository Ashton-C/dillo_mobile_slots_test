...
export const DRONE_CONTRACTS: Record<DroneType, DroneContract> = {
  SENTINEL: {
    type: 'SENTINEL',
    label: 'SENTINEL',
    description: 'Absorbs the next attack on your outpost.',
    flavour: '"It doesn\'t sleep. Neither does your base."',
    trigger: 'ON_ATTACK',
    duration: 1,
  ...
  SCRAMBLER: {
    type: 'SCRAMBLER',
    label: 'SCRAMBLER',
    description: 'Jams the next raid on your outpost, sending raiders away empty-handed.',
    flavour: '"Signal lost. Loot lost. Raiders: confused."',
    trigger: 'ON_RAID',
    duration: 1,
  ...
  HARVESTER: {
    ...
    flavour: '"Mine faster. Burn brighter."',
    trigger: 'ON_SPIN',
    duration: 8,
  ...
  RAIDER: {
    ...
    flavour: '"Precision extraction. Nothing left behind."',
