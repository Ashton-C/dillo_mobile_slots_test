...
export const ANOMALIES: Record<AnomalyId, AnomalyDefinition> = {
  SOLAR_SURGE: {
    ...
    flavour: '"The star is angry. Your wallet is happy."',
    color: '#FFD700',
    creditMultiplier: 2,
    attackMultiplier: 1,
    shieldBonus: 0,
  ...
  VOID_STORM: {
    ...
    flavour: '"Nobody is safe. That includes you."',
    color: '#FF3366',
  ...
  CREDIT_BLOOM: {
    ...
    flavour: '"The anomaly bends probability itself."',
    color: '#9B59FF',
  ...
  SHIELD_PULSE: {
    ...
    flavour: '"Even your enemies are harder to hit right now."',
    color: '#00D4FF',
    creditMultiplier: 1,
  ...
  RAID_SHADOW: {
    ...
    flavour: '"They won\'t see you coming. Neither will their Credits."',
    color: '#FF6B35',
    creditMultiplier: 1,
    attackMultiplier: 1,
    shieldBonus: 0,
  ...
  CALM: {
    ...
    flavour: '"The void is quiet. For now."',
    color: '#4A4A7A',
    creditMultiplier: 1,
    attackMultiplier: 1,
    shieldBonus: 0,
