...
const STEPS = [
  {
    ...
    title: 'WELCOME, PILOT',
    body: 'You command an armadillo in a high-tech environmental suit. Your outpost needs credits to grow — and credits come from spinning.\n\nHit SPIN on the main screen to draw from the reel.',
    cta: 'SHOW ME',
  },
  {
    icon: '⬡',
    iconColor: Colors.accent,
    title: 'BUILD YOUR OUTPOST',
    body: 'Credits fund your base. Head to the HABITAT tab to construct buildings.\n\nGENERATOR boosts your credit haul. ARMORY stockpiles fuel for attacks. HANGAR unlocks drone contracts.',
    cta: 'GOT IT',
  },
  {
    icon: '◉',
    ...
    title: 'DEPLOY DRONES',
    body: 'Once your HANGAR is built, open CONTRACTS to hire drone mercenaries. They stack passive bonuses on every spin — credit multipliers, raid boosts, and defense buffs.\n\nThe reel is just the beginning.',
    cta: "LET'S GO",
  },
] as const;
